...
void InitialiserData()
{
    ...
    gData.BouleSup.x = 0.25;
    gData.BouleSup.y = gData.BouleInf.y - rBouleInf;	// BouleSup pos�e sur BouleInf � t = 0 (donc son ordonn�e est n�gative car l'axe y est orient� vers le bas dans FLTK)
